...
export default function TransactionsPage() {
  ...
  async function handleQuickSubmit(e: React.FormEvent) {
    ...
    const account = accounts.find((a: any) => {
      ...
      return id === form.accountId;
    });
    const accountName = account?.attributes?.name || account?.name || '';
    ...
    const pendingTx: PendingTransaction = {
      ...
      categoryName: categories.find((c: any) => {
        const id = c.id || c.attributes?.id;
        return id === form.categoryId;
    ...
    setForm({ amount: '', currency: 'VES', description: '', accountId: '', type: 'withdrawal', categoryId: '' });
    setShowForm(false);
  }
